...
| Setting | What it does |
|---|---|
| **Speeder Mode** (`sdwMode`/`sdcMode`) | **Fast** targets the busy/low-interval half of the order-count sample. **Slow** targets the quiet/high-interval half. |
