...
> **Not compatible with Permafrost/Ashfall.** Leader/Follower was designed against passive bulk-fetch sharing between two independent hosts, and doesn't hold up once Permafrost-Winter or Ashfall-Chaser are running — the halt-governor plugins already maintain their own cross-bot sample state and heartbeat-driven behavior (see below), and layering Follow Partner Bot on top produces conflicting assumptions about which bot is actively scanning. Currently considered a failed concept in this pairing; leave Follow Partner Bot off when running PF/AF. May be revisited in the future.
