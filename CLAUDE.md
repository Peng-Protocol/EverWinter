...
| `PseudoWinter.html` | v1.6.8 |
| `PseudoChaser.html` | v1.2.7 |
| `PsychoWinter1.0.html` | v1.0 |
| `plugins/strategies/MultiIndicator-Winter.html` | v1.8.0 |
| `plugins/strategies/MultiIndicator-Chaser.html` | v1.8.0 |
| `plugins/analytics/Permafrost-Winter.html` | v1.14.8 |
| `plugins/analytics/Ashfall-Chaser.html` | v1.14.9 |
